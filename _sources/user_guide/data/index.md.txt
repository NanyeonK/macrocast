...
| Raw source cleaning | 2 | `raw_missing_policy`, `raw_outlier_policy` before FRED transforms/T-codes |
| FRED transforms | 2 | `official_transform_policy`, `official_transform_scope` |
...
- **Kept in Layer 1** — dataset/source/frequency/information set, FRED-SD source selection, target structure, raw variable universe, raw-source cleaning, FRED transforms, FRED availability, release lag, and contemporaneous information rule.

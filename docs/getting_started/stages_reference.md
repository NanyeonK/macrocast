...
**Scope.** Layer 0 (Design, §0.1–§0.6) + Layer 1 (Data, §1.1–§1.5). Layer 2+ (preprocessing, training, evaluation, provenance, stat tests, importance) are still in active development and their axes are documented in [User Guide / Registry](../user_guide/registry.md).

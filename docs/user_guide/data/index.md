...
Stage 1 holds **33 meta axes** under the `1_data_task` layer, organised into five groups:
...
Layer 1 covers 33 axes. After the v0.9.3 Tier 1-3 drop and the ongoing §1.1+ cleanup, the current breakdown is:

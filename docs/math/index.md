...
Formal definitions for researchers who need to cite or verify macrocast computations.

| Topic | Content |
|-------|---------|
| [Evaluation Metrics](evaluation_metrics.md) | MSFE, RMSE, MAE, OOS R-squared, relative metrics |

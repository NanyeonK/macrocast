...
| `rotation_feature_block` | 2_preprocessing | `none` and `moving_average_rotation` operational through raw-panel bridge lowering; MARX, MAF, custom rotations, and rotation composition remain gated |

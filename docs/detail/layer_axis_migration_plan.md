...
| `temporal_feature_block` | 2_preprocessing | `none` and `moving_average_features` operational through raw-panel bridge lowering; X-lag/factor composition and other temporal blocks remain gated |

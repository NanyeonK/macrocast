...
| Other feature-block primitive axes | none | `feature_block_set`, `rotation_feature_block`, `temporal_feature_block`, and `feature_block_combination` remain registry-only. |

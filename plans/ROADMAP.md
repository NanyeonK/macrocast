...
| — (v0.9.2 interim) | completed | v0.9.2 | PR #17 | 2026-04-18 |
| 8-11 | pending | - | - | - |

현재 live phase: **Phase 8 kickoff 대기** (Phase 0-7 + v0.9.1 + v0.9.2 interims merged, v0.2~v0.9.2 tagged on origin/main). v0.9.2 promoted all 130 planned values to operational; 526/809 registry values operational (65%), 0 planned remain.

...
AXIS_DEFINITION = AxisDefinition(
    ...
    entries=(
        EnumRegistryEntry(id='none', description='no artifacts saved', status='operational', priority='A'),
        ...
        EnumRegistryEntry(id='models_only', description='model artifacts only', status="operational", priority='B'),
        EnumRegistryEntry(id='data_only', description='processed data artifacts only', status="operational", priority='B'),
    ),
    compatible_with={},
    incompatible_with={},
)

...
AXIS_DEFINITION = AxisDefinition(
    ...
    entries=(
        ...
        EnumRegistryEntry(id="mcnemar",        description="McNemar test for paired binary hits", status="operational", priority="B"),
        EnumRegistryEntry(id="roc_comparison", description="Paired ROC-curve comparison", status="operational", priority="B"),
    ),
    compatible_with={},
    incompatible_with={},
)

...
AXIS_DEFINITION = AxisDefinition(
    ...
    entries=(
        ...
        EnumRegistryEntry(id="stepwise_mcs",         description="Stepwise MCS variant", status="operational", priority="B"),
        EnumRegistryEntry(id="bootstrap_best_model", description="Bootstrap best-model selection", status="operational", priority="B"),
    ),
    compatible_with={},
    incompatible_with={},
)

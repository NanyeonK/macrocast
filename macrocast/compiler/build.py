...
def _evaluation_spec(selection_map: dict[str, AxisSelection], leaf_config: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "agg_time": _selection_value(selection_map, "agg_time", default="full_out_of_sample_average"),
        ...
        "regime_use": _selection_value(selection_map, "regime_use", default="evaluation_only"),

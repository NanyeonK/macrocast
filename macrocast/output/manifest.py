...
def build_run_manifest(*, run_id: str, experiment_id: str, config_hash: str, code_version: str, dataset_ids: list[str], benchmark_ids: list[str], artifact_paths: dict[str, str], success: bool = True, failure_summary: list[str] | None = None, environment_fingerprint: dict[str, Any] | None = None, degraded: bool = False, provenance_fields: list[str] | None = None, recipe_id: str | None = None, taxonomy_path: dict[str, Any] | None = None, tree_context: dict[str, Any] | None = None) -> dict[str, Any]:
